...
import { createExampleSchema, updateExampleSchema, exampleIdSchema } from "./example.schema";
...
router.put("/:id", validate(exampleIdSchema, "params"), validate(updateExampleSchema), exampleController.update);
