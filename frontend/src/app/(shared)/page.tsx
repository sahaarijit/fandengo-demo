      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
          <h2 className="text-lg font-semibold text-blue-900 dark:text-blue-100 mb-2">
            Welcome to the MENN Stack Boilerplate
          </h2>
          <p className="text-sm text-blue-800 dark:text-blue-200 mb-4">
            This is a production-ready boilerplate with feature-based architecture. The backend uses
            MongoDB + Mongoose with Express, and the frontend uses Next.js 16 with TypeScript and Shadcn UI.
          </p>
          <Link
            href="/example"
