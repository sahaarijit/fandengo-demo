			...
			<div className="container mx-auto px-4">
				<div className="flex items-center justify-between h-16">
					...
					<Link href="/movies" className="flex items-center gap-2 group">
						...
						<span className="text-2xl font-bold text-white group-hover:text-orange-400 transition-colors">Fandango</span>
					</Link>
					...
					<div className="hidden md:flex items-center gap-6">
						...
						{isAuthenticated ? (
							...
							<div className="flex items-center gap-3">
								<Link href="/auth/login" className="px-4 py-2 text-white hover:text-orange-400 transition-colors">
									Login
								</Link>
								<Link
									href="/auth/signup"
					...
					{/* Mobile Menu Button */}
					<button onClick={() => setShowMobileMenu(!showMobileMenu)} className="md:hidden p-2 text-gray-300 hover:text-white">
